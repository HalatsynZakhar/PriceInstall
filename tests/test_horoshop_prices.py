...
class HoroshopPricesTests(unittest.TestCase):
    ...
    def test_mapping_row_uses_every_article_variant_including_internal_article(self):
        ...
        self.assertEqual(mappings.targets_for("SELLER-1", False), ("SELLER-1", "Visible-1", "TECH/1 (A)"))
    ...
    def test_mapping_uses_all_rows_with_the_same_key(self):
        ...
        plans = plan_prices([row], catalog, self.settings(), mappings=mappings)
        self.assertEqual(mappings.targets_for("12520", False), ("12520", "12520-12513", "12520-12516"))
        self.assertEqual([plan.article for plan in plans], ["12520", "12520-12513", "12520-12516"])
